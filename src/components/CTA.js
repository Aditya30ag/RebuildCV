    ...
    <div>
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-gray-900/70 backdrop-blur-lg p-12 rounded-2xl border border-gray-800">
            ...
            <p className="text-xl text-gray-300 mb-8">Join thousands of successful job seekers who've optimized their resumes with RebuildCV</p>
            <button
            ...
            <p className="mt-4 text-gray-400">No credit card required. One free resume optimization.</p>
          </div>
        </div>
      </section>
