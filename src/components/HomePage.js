...
export default function HomePage() {
  ...
  return (
    <div>
        <Navigation isModalOpen={isModalOpen} handleonchange={handleonchange}/>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2 space-y-8">
            ...
            >
              ...
              <a href="#pricing" className="px-8 py-4 rounded-lg border border-gray-700 bg-gray-200/50 backdrop-blur-sm hover:bg-gray-800 hover:text-white transition text-lg font-medium flex items-center justify-center">
                View Pricing
              </a>
            </motion.div>
          </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm" onClick={() => setIsModalOpen(false)}>
          ...
          >
            ...
            <p className="text-gray-300 mb-6">Create one fully optimized resume for free, no credit card required.</p>
